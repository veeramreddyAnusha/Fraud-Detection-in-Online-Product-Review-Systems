      ...
      <div class="sidebar">
        <div class="gadget">
          <table width="940" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="932"><p class="style36 style35 style98">Products Consumed  by <span class="star style35">Friends</span> based on Likes and Recommendations..</p>
		...
		%>
		  <table width="941" border="0" cellspacing="2" cellpadding="2">
                   ...
                   <tr>
                     ...
                     <td width="167"><label>
                         <div align="left">
						   ...
						   <input type="hidden" value=<%="likes"%> name="likes"/>
                         </div>
                      </label></td>
                   </tr>
                   <tr>
			 ...
			 String query3="select distinct(user) FROM likes where user!='"+user+"'"; 
			   ...
			   while ( rs3.next() )
			   {
				   ...
				   if ( rs4.next() )
				   {
						 String query5="select distinct(title) FROM likes where user='"+friend1+"'"; 
                     ...
                     <td width="182"><label>
                         <div align="left">
                          <select id="s1" name="title" style="width:150px">
						    ...
						    <input type="hidden" value=<%="recommend"%> name="likes"/>
                         </div>
                      </label></td>
                   </tr>
                   <tr>
           ...
           <table width="428" border="0" cellspacing="2" cellpadding="2">
             <tr>
               <td width="420" height="37"><div align="left"><span class="star style35">Liked Friends on Post '<span class="style106"><%=request.getParameter("title")%></span>'</span></div></td>
             </tr>
          </table>
           <table width="902" border="0" cellspacing="2" cellpadding="2">
             <tr>
               <td width="409" height="44"><table  width="409" border="0" align="center" cellpadding="2" cellspacing="2">
                 <tr>
                   <td width="401"><div class="templatemo_h_line">
                       <div align="center" id="circle2">
						...
						try 
						{
							...
							String option=request.getParameter("likes");
					  ...
					  %>
                           <a href="U_ConsumerProfile.jsp?username=<%=username6%>&amp;title=<%=title6%>"><img src="user_Pic.jsp?id=<%=id7%>" width="82" height="75" alt="" class="gal" id="circle" /></a>
                           <%
			   ...
			   <table width="902" border="0" cellspacing="2" cellpadding="2">
             <tr>
               <td width="479"><table  width="409" border="0" align="center" cellpadding="2" cellspacing="2">
                 <tr>
                   <td width="401"><div class="templatemo_h_line">
                       <div align="center" id="circle3">
                         <div align="center">
                           <%
										...
										int loop8=2;
										String query88="select distinct(user) from likes where title='"+title6+"'"; 
										Statement st88=connection.createStatement();
										ResultSet rs88=st88.executeQuery(query88);
										while ( rs88.next() )
										{
			
												String username88=rs88.getString(1);
												
											String query81="select * from frequest where  ((requestfrom='"+user+"' and requestto='"+username88+"')|| (requestfrom='"+username88+"' and requestto='"+user+"')) && status='Accepted'";
											Statement st81=connection.createStatement();
											ResultSet rs81=st81.executeQuery(query81);
										   if ( rs81.next() )
										   {
												
												String query71="select id from user where username='"+username88+"'"; 
					  ...
					  %>
                           <a href="U_ConsumerProfile.jsp?username=<%=username88%>&amp;title=<%=title6%>"><img src="user_Pic.jsp?id=<%=id71%>" width="82" height="75" alt="" class="gal" id="circle" /></a>
                           <%
