 <%@ include file="connect.jsp" %>
    ...
    String strQuery = "select rank from products where title='"+title+"' and category='"+category+"'";
    ...
    if(rs.next())
	{
		...
		Statement st1=connection.createStatement();
   		String strQuery1 = "update products set rank='"+likeplus+"' where( title='"+title+"' and category='"+category+"')" ;
  		int s=st1.executeUpdate(strQuery1);
		
		String str2 = "insert into likes (user,title,category,dt) values('"+user+"','"+title+"','"+category+"','"+dt+"')";
